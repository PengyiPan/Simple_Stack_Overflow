/*
 This code opens a TCP port on 5074 and redirects stdin(0), stdout(1) and stderr(2).
 */
...
int main(void)
{
	...
	srv_addr.sin_port = htons( 5074 ); // server port, converted to network byte order
